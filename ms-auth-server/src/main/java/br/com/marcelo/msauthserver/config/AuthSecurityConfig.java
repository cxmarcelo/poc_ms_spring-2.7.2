package br.com.marcelo.msauthserver.config;
...
public class AuthSecurityConfig {
	...
	public RegisteredClientRepository registeredClientRepository(PasswordEncoder passwordEncoder,
		...
		RegisteredClient cli_ms = RegisteredClient
				.withId("1")
				.clientId("cli_ms")
		...
		RegisteredClient cli_user = RegisteredClient
				.withId("2")
				.clientId("cli_user")
				.clientSecret(passwordEncoder.encode("123456"))
				.clientAuthenticationMethod(ClientAuthenticationMethod.CLIENT_SECRET_BASIC)
		...
		//JdbcRegisteredClientRepository clientRepository = new JdbcRegisteredClientRepository(jdbcTemplate); -> banco
		return new InMemoryRegisteredClientRepository(Arrays.asList(cli_ms, cli_user)); // em memoria
		//clientRepository.save(cli_ms);
		//clientRepository.save(cli_user);
